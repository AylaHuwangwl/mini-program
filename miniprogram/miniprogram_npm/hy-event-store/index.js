...
__DEFINE__(1677654221661, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1677654221662,"./event-store":1677654221663}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677654221662, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1677654221663, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1677654221662,"./utils":1677654221664}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677654221664, function(require, module, exports) {
...
return __REQUIRE__(1677654221661);
})()
